...
face_cascade_db = cv2.CascadeClassifier(f"../Recognition_Face/haarcascade_frontalface_default.xml")
root = Tk()
...
def open_photo():
    img = cv2.imread(f"../Recognition_Face/Faces/{text.get()}.png") # Чтение фото(ввод названия файла вручную)
